...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients, 
                num_classes, statistic, niid=False, balance=True, partition=None, feature_dim=None):
    config = {
    ...
    # Add feature dimension if provided (important for credit datasets after toad filtering)
    if feature_dim is not None:
        config['feature_dim'] = feature_dim
        print(f"[CONFIG] Saving feature_dim = {feature_dim} to config.json")
